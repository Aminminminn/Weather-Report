...
public class Carousel extends Widget {
	 ...
	 *
	 * @param entries           the carousel entries
	 * @param initialEntryIndex the initial entry index
	 * @param entryWidth        the width of an entry
	 * @param entryHeight       the maximum height of an entry
	 */
	public Carousel(CarouselEntry[] entries, int initialEntryIndex, int entryWidth, int entryHeight) {
		...
		// init repaint task
		this.repaintAnimation = currentTimeMillis -> {
			repaintTick();
	 ...
	 *
	 * @param entryIndex the entry index to scroll to
	 * @param anim       whether we should use an animation or scroll there directly
	 */
